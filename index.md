...
##第三方引用
- Spring 3.2：主要应用IOC、AOP、事件、JDBC、事务管理、定时调度
- druid 1.0：数据库连接池
...
# 数据库建表约束
1. 当前只能支持MySQL数据库，支持版本 5.5、5.6、5.7
...
- **是否可用**	是否在编辑界面中可用
- **是否可见**	是否在列表界面中可见
- **字段同步**	在修改同一对象下同名属性（对象属性和方法属性）时是否同步和被同步，默认是同步的
